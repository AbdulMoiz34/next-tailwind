      ...
      <div className="pt-6">
        ...
        <div className="mx-auto mt-6 max-w-2xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:gap-x-8 lg:px-8">
          ...
          <div className="aspect-h-5 aspect-w-4 lg:aspect-h-4 lg:aspect-w-3 sm:overflow-hidden sm:rounded-lg">
            <img src="https://tailwindui.com/img/ecommerce-images/product-page-02-featured-product-shot.jpg" alt={product.imageAlt} className="h-full w-full object-cover object-center" />
          </div>
        </div>
...
export const getServerSideProps = async ({ params }) => {
  ...
  if (!product) { //if product is not available so 404 will true
    return {
      notFound: true
    }
  }
